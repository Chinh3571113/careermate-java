...
public enum ErrorCode {
        ...
        CANNOT_EDIT_JOB_WITH_APPLICANTS(6023, 
                        "Cannot edit job posting content after candidates have applied. Only expiration date changes are allowed.",
                        HttpStatus.FORBIDDEN),
        EXPIRATION_DATE_TOO_SHORT(6024, 
                        "Cannot shorten expiration date by more than 7 days. This protects candidates who planned to apply.",
                        HttpStatus.BAD_REQUEST),
        EXPIRATION_DATE_TOO_LONG(6025, 
                        "Cannot extend expiration date by more than 60 days at once.",
                        HttpStatus.BAD_REQUEST),
        CANNOT_PAUSE_NON_ACTIVE(6026,
                        "Only ACTIVE jobs can be paused.",
                        HttpStatus.BAD_REQUEST),
        JOB_ALREADY_PAUSED(6027,
                        "Job posting is already paused.",
                        HttpStatus.BAD_REQUEST),
        CANNOT_RESUME_NON_PAUSED(6028,
                        "Only PAUSED jobs can be resumed.",
                        HttpStatus.BAD_REQUEST),
        CANNOT_CLOSE_NON_ACTIVE(6029,
                        "Only ACTIVE jobs can be closed.",
                        HttpStatus.BAD_REQUEST),
        JOB_ALREADY_CLOSED(6030,
                        "Job posting is already closed.",
                        HttpStatus.BAD_REQUEST),
        CANNOT_DELETE_WITH_APPLICANTS(6031,
                        "Cannot delete job posting that has received applications.",
                        HttpStatus.FORBIDDEN),
        ...
        INTERVIEW_ALREADY_SCHEDULED(9101, "Interview already scheduled for this job application",
                        HttpStatus.BAD_REQUEST),
        ...
        CANNOT_RESCHEDULE_COMPLETED_INTERVIEW(9104, "Cannot reschedule a completed or cancelled interview",
                        HttpStatus.BAD_REQUEST),
        RESCHEDULE_TOO_LATE(9105, "Cannot reschedule interview less than 2 hours before scheduled time",
                        HttpStatus.BAD_REQUEST),
        INTERVIEW_ALREADY_CANCELLED(9106, "This interview has been cancelled", HttpStatus.BAD_REQUEST),
        INTERVIEW_ALREADY_COMPLETED(9107, "This interview has already been completed", HttpStatus.BAD_REQUEST),
        INTERVIEW_MARKED_NO_SHOW(9108, "This interview has been marked as no-show", HttpStatus.BAD_REQUEST),
        ...
        CANNOT_MARK_NO_SHOW_BEFORE_TIME(9110, "Cannot mark as no-show before scheduled interview time",
                        HttpStatus.BAD_REQUEST),
        ...
        INTERVIEW_TOO_SHORT(9113, "Interview must last at least 50% of scheduled duration to complete early",
                        HttpStatus.BAD_REQUEST),
        INTERVIEW_CANNOT_BE_MODIFIED(9114, "Cannot modify completed, cancelled, or no-show interviews",
                        HttpStatus.BAD_REQUEST),
        ...
        REVIEW_ALREADY_SUBMITTED(9302, "You have already submitted a review for this job application",
                        HttpStatus.BAD_REQUEST),
        ...
        EMPLOYMENT_VERIFICATION_EXISTS(9401, "Employment verification already exists for this job application",
                        HttpStatus.BAD_REQUEST),
        EMPLOYMENT_ALREADY_TERMINATED(9402, "Employment has already been terminated", HttpStatus.BAD_REQUEST),

        // PDF Export Error Codes (9500-9599)
        INVALID_TEMPLATE(9500, "Invalid template ID. Valid templates: classic, modern, professional, vintage",
                        HttpStatus.BAD_REQUEST),
        PDF_GENERATION_FAILED(9501, "Failed to generate PDF document", HttpStatus.INTERNAL_SERVER_ERROR),
        TEMPLATE_RENDERING_FAILED(9502, "Failed to render CV template", HttpStatus.INTERNAL_SERVER_ERROR);
